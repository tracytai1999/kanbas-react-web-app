      ...
      <div>
        ...
        <ul id="wd-modules">
          <li className="wd-module">
            <div className="wd-title">Week 1, Lecture 1, Class Introduction, Syllabus, Agenda</div>
            <ul className="wd-lessons">
              <li className="wd-lesson">
                ...
                <ul className="wd-content">
                  <li className="wd-content-item">Full Stack Develper - Chapter 1 - Introduction</li>
                  <li className="wd-content-item">Full Stack Develper - Chapter 2 - Creating User</li>
                </ul>
